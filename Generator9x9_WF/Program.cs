...
namespace Generator9x9_WF
{
    ...
    public enum DifficultyLevel { EASY_9x9 = 38, MEDIUM_9x9 = 30, HARD_9x9 = 25, EXPERT_9x9 = 23, NORMAL_16x16 = 121 };
    ...
    public class Generator
    {
        ...
        private void CloseTiles_2()
        {
            ...
            int difficult = N * N;
            int temp = 0;
            while (counter < (N * N) && (difficult >= (int)difficulty || difficulty==DifficultyLevel.HARD_9x9))
            {
